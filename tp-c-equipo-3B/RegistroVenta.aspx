...
<!-- SideNavBar -->
<aside class="w-64 bg-white dark:bg-background-dark shadow-md flex-shrink-0">
<div class="p-4">
<div class="flex items-center gap-3 mb-6">
<div class="bg-center bg-no-repeat aspect-square bg-cover rounded-full size-10" data-alt="Logotipo del negocio" style='background-image: url("https://lh3.googleusercontent.com/aida-public/AB6AXuD13Z1r_h3sU5bT8liXnrS57We9s1V2yCyYt6uSwtD1kO4h94aCOjxGkbAjxqMel6QPQkUSc31_-cq4V5Y-rFdMflKHxifC6Wh1B3L394gG-TaPbgA0LpEkn3XBNuRkybLq08DSFtb5zLXnvHd9lx2btny4L0WJfzGs3XRlIRPyWaMoMSECik1PsRBgxBSpZs0EFbduKdrJ5UGpSjNYE_NqCwNwEnYYTHYD0IfDubqIcYE7HZCDdMCcvLnd57A0xs-N4xBv8weeuymI");'></div>
<div class="flex flex-col">
<h1 class="text-base font-medium leading-normal text-gray-800 dark:text-gray-200">Mi Negocio</h1>
<p class="text-sm font-normal leading-normal text-gray-500 dark:text-gray-400">Gestión de Ventas</p>
</div>
</div>
<nav class="flex flex-col gap-2">
<a class="flex items-center gap-3 px-3 py-2 rounded-lg text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700" href="#">
...
<button class="w-full flex items-center justify-center rounded-lg h-10 px-4 bg-primary text-white text-sm font-bold">
