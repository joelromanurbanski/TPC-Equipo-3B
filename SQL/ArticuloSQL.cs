...
namespace SQL
{
    public class ArticuloSQL
    {
        public List<Articulo> Listar()
        {
            ...
            try
            {
                datos.setearConsulta(@"SELECT A.Id, Codigo, Nombre, A.Descripcion, A.Precio, 
                            ...
                            (SELECT TOP 1 UrlImagen  FROM Imagen WHERE IdArticulo = A.Id) UrlImagen
                            FROM Articulo A
        ...
        public int AgregarYDevolverId(Articulo nuevo)
        {
            ...
            try
            {
                datos.setearConsulta("INSERT INTO Articulo (Codigo, Nombre, Descripcion, Precio, IdMarca, IdCategoria) " +
